    ...
    printf("State: Data capture and accumulation in progress\n");
      ...
      printf("FT_Read (%d) failed\n", iport);
       ...
       for(dctr=1;dctr<4096;dctr++){        //run from 1 to 1023 to avoid the DC
               ...
               data_out_accum[dctr] = data_out;
	       data_out_db[dctr] = 10 * log( (double) data_out);
       ...
       data_out_db[0] = data_out_db[6];
       data_out_db[1] = data_out_db[6];
       data_out_db[2] = data_out_db[6];
       data_out_db[3] = data_out_db[6];
       data_out_db[4] = data_out_db[6];
       data_out_db[5] = data_out_db[6];
       data_out_db[1023] =data_out_db[1022] ;
       data_out_db[2047] =data_out_db[2046] ;
       data_out_db[2048] =data_out_db[2049] ;
       data_out_db[3071] =data_out_db[3070] ;
